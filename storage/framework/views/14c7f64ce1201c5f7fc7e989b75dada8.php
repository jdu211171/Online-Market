...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['parentCategories', 'productsMenu']));
...
foreach (array_filter((['parentCategories', 'productsMenu']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
                            ...
                            <ul class="navbar-nav flex flex-wrap flex-row">
                                ...
                                <li class="nav-item bb-main-dropdown flex items-center mr-[45px]">
                                    ...
                                    <ul class="mega-menu min-w-full transition-all duration-[0.3s] ease-in-out mt-[25px] pl-[30px] absolute top-[40px] z-[16] text-left opacity-[0] invisible left-[0] right-[auto] bg-[#fff] border-[1px] border-solid border-[#eee] flex flex-col rounded-[10px]">
                                        <li class="m-[0] flex items-center">
                                            <?php $__currentLoopData = $parentCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Categories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <ul class="mega-block w-[calc(25%-30px)] mr-[30px] py-[15px]">
                                                    <li class="menu_title border-b-[1px] border-solid border-[#eee] mb-[10px] pb-[5px] flex items-center leading-[28px]"><a href="javascript:void(0)" class="transition-all duration-[0.3s] ease-in-out font-Poppins h-[auto] text-[#6c7fd8] text-[15px] font-medium tracking-[0.03rem] block py-[10px] leading-[22px] capitalize"><?php echo e($Categories->name); ?></a></li>
                                                    <?php $__currentLoopData = $Categories->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childCategories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="flex items-center leading-[28px]"><a href="shop-left-sidebar-col-3.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize"><?php echo e($childCategories->name); ?></a></li>
                                ...
                                <li class="nav-item bb-dropdown flex items-center relative mr-[45px]">
                                    ...
                                    <ul class="bb-dropdown-menu min-w-[205px] p-[10px] transition-all duration-[0.3s] ease-in-out mt-[25px] absolute top-[40px] z-[16] text-left opacity-[0] invisible left-[0] right-[auto] bg-[#fff] border-[1px] border-solid border-[#eee] flex flex-col rounded-[10px]">
                                        <?php $__currentLoopData = $productsMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="bb-mega-dropdown m-[0] py-[5px] px-[15px] relative flex items-center">
                                                <a class="bb-mega-item transition-all duration-[0.3s] ease-in-out font-Poppins py-[5px] leading-[22px] text-[14px] font-normal text-[#686e7d] hover:text-[#6c7fd8] capitalize tracking-[0.03rem]" href="<?php echo e($productMenu->link); ?>"><?php echo e($productMenu->name); ?></a>
                                                <?php if(empty($productMenu->children)): ?>
                                                    <ul class="bb-mega-menu transition-all duration-[0.3s] ease-in-out min-w-[220px] p-[10px] mt-[25px] absolute top-[-20px] left-[193px] z-[16] text-left opacity-[0] invisible right-[auto] bg-[#fff] border-[1px] border-solid border-[#eee] flex flex-col rounded-[10px]">
                                                        <?php $__currentLoopData = $productMenu->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childCategories): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class="m-[0] py-[5px] px-[15px] flex items-center">
                                                                <a class="dropdown-item transition-all duration-[0.3s] ease-in-out py-[6px] text-[14px] font-normal text-[#686e7d] hover:text-[#6c7fd8] capitalize" href="<?php echo e($childCategories->link); ?>"><?php echo e($childCategories->name); ?></a>
                                                            </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                <?php endif; ?>
    ...
    <div id="bb-mobile-menu" class="bb-mobile-menu transition-all duration-[0.3s] ease-in-out w-[340px] h-full pt-[15px] px-[20px] pb-[20px] fixed top-[0] right-[auto] left-[0] bg-[#fff] translate-x-[-100%] flex flex-col z-[17] overflow-auto max-[480px]:w-[300px]">
        ...
        <div class="bb-menu-inner">
            <div class="bb-menu-content">
                <ul>
                    <li class="relative">
                        <a class="transition-all duration-[0.3s] ease-in-out mb-[12px] p-[12px] block font-Poppins capitalize text-[#686e7d] border-[1px] border-solid border-[#eee] rounded-[10px] text-[15px] font-medium leading-[28px] tracking-[0.03rem]" href="<?php echo e(route('home')); ?>">
                            Home
                        </a>
                    </li>
                    <li class="relative">
